...
//     ctx.fillStyle = 'white';     
//     ctx.font = '25px Ariel';
//     ctx.fillText('Spiritual Awakening', 60, 50);
//     ctx.font = '20px Ariel';
//     ctx.fillText('"The ability of discovering who you are."', 60, 90);
//     ctx.font = '15px Ariel';
  
//     ctx.fillText('Music Visualizer Created by Wolfkang Lim', canvas.width * 2 / 3 , canvas.height * 0.98);
// }

//canvs to webm video file download
//another from pretagteam
